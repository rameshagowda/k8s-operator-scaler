/*
Copyright 2024 ramesha c gowda.
...
import (
	...
	apiv1alpha1 "github.com/rameshagowda/k8s-operator-scaler/api/v1alpha1"
...
//+kubebuilder:rbac:groups=api.rcgowda-operator.io,resources=scalers,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=api.rcgowda-operator.io,resources=scalers/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=api.rcgowda-operator.io,resources=scalers/finalizers,verbs=update
